<?php
// src/KK/BlogBundle/Tests/Entity/Repository/BlogRepositoryTest.php

namespace KK\BlogBundle\Tests\Entity\Repository;

use KK\BlogBundle\Entity\Repository\BlogRepository;
use Symfony\Bundle\FrameworkBundle\Test\WebTestCase;

class BlogRepositoryTest extends WebTestCase
{
    /**
     * @var \KK\BlogBundle\Entity\Repository\BlogRepository
     */
    ...
    public function setUp()
    {
        ...
        $this->blogRepository = $kernel->getContainer()
                ...
                ->getRepository('KKBlogBundle:Blog');
    ...
    public function testGetTagWeights()
    {
        ...
        $tagsWeight = $this->blogRepository->getTagWeights(
            array_merge(array_fill(0, 5, 'php'), array_fill(0, 1, 'html'), array_fill(0, 3, 'js'))
        );
